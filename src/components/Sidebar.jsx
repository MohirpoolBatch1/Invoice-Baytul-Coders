  ...
  return (
    <div className="sidebar h-screen w-[6.438rem] rounded-tr-[1.25rem] rounded-br-[1.25rem]">
      <div className="sidebar-top absolute flex h-[6.438rem] w-[6.438rem] items-center justify-center rounded-br-[1.25rem] rounded-tr-[1.25rem] bg-purple">
        ...
        <div className="sidebar-inner absolute top-[3.188rem] h-[3.25rem] w-[6.438rem] rounded-tl-[1.25rem] rounded-br-[1.25rem] bg-purple-light"></div>
      </div>
      <div className="sidebar-bottom bg-grayBlack flex h-screen w-[6.438rem] flex-col items-center justify-end rounded-tr-[1.25rem] rounded-br-[1.25rem] bg-[#373B53] ">
